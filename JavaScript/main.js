...
consoleText(
  ['Welcome to my online resume!', 'I hope you will enjoy', 'Take a look'],
  'text'
);

const desc = [
  ['React', 'Redux', 'HTML', 'CSS', 'PHP', 'SasS', 'Firebase', 'Git'],
  [
...
const sendData = () => {
  checkData(data) &&
    fetch('https://portfolio-84a25.firebaseio.com/messages.json', {
      method: 'POST',
